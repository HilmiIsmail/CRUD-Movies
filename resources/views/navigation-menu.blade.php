            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                        <i class="fa-solid fa-table-columns mr-2"></i>{{ __('Dashboard') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('categories.index') }}" :active="request()->routeIs('categories.*')">
                        <i class="fa-solid fa-layer-group mr-2"></i>Gestionar Categorias
                    </x-nav-link>
                    <x-nav-link href="{{ route('etiquetas.index') }}" :active="request()->routeIs('etiquetas.*')">
                        <i class="fa-solid fa-hashtag mr-2"></i>Gestion Etiquetas
                    </x-nav-link>
                    <x-nav-link href="{{ route('peliculas.show') }}" :active="request()->routeIs('peliculas.show')">
                        <i class="fa-solid fa-clapperboard mr-2"></i>Gestion Peliculas
                    </x-nav-link>
                </div>
            </div>
